...
/*
 * This file works only on linux, nuclei-sdk has its own nmsis_bench.h when you build barematal elf
 */
#if defined(__linux)
/*!
 * @file     nmsis_bench.h
...
#define RDCYCLE_H()     csr_read(cycleh)

static inline uint64_t get_rv_cycle(void)
{
#if __riscv_xlen == 32
...
#define BENCH_DECLARE_VAR()     static volatile unsigned long _bc_sttcyc, _bc_endcyc, _bc_usecyc, _bc_sumcyc; \
