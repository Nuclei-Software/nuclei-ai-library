...
int test_batchnormalization_f32(void)
{
    ...
    node->inputs[2] = (struct onnx_tensor_t *)malloc(sizeof(struct onnx_tensor_t));
    node->inputs[2]->ndim = 1;
    node->inputs[2]->dims = (int *)malloc(sizeof(int) * node->inputs[2]->ndim);
    node->inputs[2]->dims[0] = DIM1;
    node->inputs[2]->ndata = node->inputs[2]->dims[0];
    node->inputs[2]->datas = malloc(sizeof(float32_t) * node->inputs[2]->ndata);

    node->inputs[3] = (struct onnx_tensor_t *)malloc(sizeof(struct onnx_tensor_t));
    node->inputs[3]->ndim = 1;
    node->inputs[3]->dims = (int *)malloc(sizeof(int) * node->inputs[3]->ndim);
    node->inputs[3]->dims[0] = DIM1;
    node->inputs[3]->ndata = node->inputs[3]->dims[0];
    node->inputs[3]->datas = malloc(sizeof(float32_t) * node->inputs[3]->ndata);

    node->inputs[4] = (struct onnx_tensor_t *)malloc(sizeof(struct onnx_tensor_t));
    node->inputs[4]->ndim = 1;
    node->inputs[4]->dims = (int *)malloc(sizeof(int) * node->inputs[4]->ndim);
    node->inputs[4]->dims[0] = DIM1;
    node->inputs[4]->ndata = node->inputs[4]->dims[0];
    node->inputs[4]->datas = malloc(sizeof(float32_t) * node->inputs[4]->ndata);
...
int test_batchnormalization_f16(void)
{
    ...
    node->inputs[2]->dims[0] = DIM1;
    node->inputs[2]->ndata = node->inputs[2]->dims[0];
    node->inputs[2]->datas = malloc(sizeof(float16_t) * node->inputs[2]->ndata);
    ...
    node->inputs[3]->dims[0] = DIM1;
    node->inputs[3]->ndata = node->inputs[3]->dims[0];
    node->inputs[3]->datas = malloc(sizeof(float16_t) * node->inputs[3]->ndata);
    ...
    node->inputs[4]->dims[0] = DIM1;
    node->inputs[4]->ndata = node->inputs[4]->dims[0];
    node->inputs[4]->datas = malloc(sizeof(float16_t) * node->inputs[4]->ndata);
