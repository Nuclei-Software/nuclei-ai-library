...
int test_sin_f32(void)
{
    ...
    BENCH_START(Sin_float32);
    Sin_float32(node);
    BENCH_END(Sin_float32);
    ...
    BENCH_START(Sin_float32_rvv);
    Sin_float32_rvv(node);
    BENCH_END(Sin_float32_rvv);
...
int test_sin_f16(void)
{
    ...
    BENCH_START(Sin_float16);
    Sin_float16(node);
    BENCH_END(Sin_float16);
    ...
    BENCH_START(Sin_float16_rvv);
    Sin_float16_rvv(node);
    BENCH_END(Sin_float16_rvv);
...
int test_sin_bf16(void)
{
    ...
    BENCH_START(Sin_bfloat16);
    Sin_bfloat16(node);
    BENCH_END(Sin_bfloat16);
    ...
    BENCH_START(Sin_bfloat16_rvv);
    Sin_bfloat16_rvv(node);
    BENCH_END(Sin_bfloat16_rvv);
