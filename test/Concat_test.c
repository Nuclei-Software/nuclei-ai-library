...
int test_concat_int8()
{
    ...
    for (int i = 0; i < INPUT_TENSORS; ++i) {
        node->inputs[i] = (struct onnx_tensor_t *)malloc(sizeof(struct onnx_tensor_t));
        node->inputs[i]->ndata = SIZE * SIZE;
        node->inputs[i]->ndim = 2;
        node->inputs[i]->dims = (int *)malloc(sizeof(int) * node->inputs[i]->ndim);
        node->inputs[i]->dims[0] = SIZE;
        node->inputs[i]->dims[1] = SIZE;
        node->inputs[i]->datas = malloc(sizeof(int8_t) * node->inputs[i]->ndata);
...
int test_concat_int32()
{
    ...
    for (int i = 0; i < INPUT_TENSORS; ++i) {
        ...
        node->inputs[i]->dims[0] = SIZE;
        node->inputs[i]->dims[1] = SIZE;
        node->inputs[i]->datas = malloc(sizeof(int32_t) * node->inputs[i]->ndata);
...
int test_concat_float16()
{
    ...
    for (int i = 0; i < INPUT_TENSORS; ++i) {
        ...
        node->inputs[i]->dims[0] = SIZE;
        node->inputs[i]->dims[1] = SIZE;
        node->inputs[i]->datas = malloc(sizeof(float16_t) * node->inputs[i]->ndata);
...
int test_concat_float32()
{
    ...
    for (int i = 0; i < INPUT_TENSORS; ++i) {
        ...
        node->inputs[i]->dims[0] = SIZE;
        node->inputs[i]->dims[1] = SIZE;
        node->inputs[i]->datas = malloc(sizeof(float32_t) * node->inputs[i]->ndata);
