...
int test_silu_f32(void)
{
    ...
    BENCH_START(Silu_float32);
    Silu_float32(node);
    BENCH_END(Silu_float32);
    ...
    BENCH_START(Silu_float32_rvv);
    Silu_float32_rvv(node);
    BENCH_END(Silu_float32_rvv);
...
int test_silu_f16(void)
{
    ...
    BENCH_START(Silu_float16);
    Silu_float16(node);
    BENCH_END(Silu_float16);
    ...
    BENCH_START(Silu_float16_rvv);
    Silu_float16_rvv(node);
    BENCH_END(Silu_float16_rvv);
...
int test_silu_bf16(void)
{
    ...
    BENCH_START(Silu_bfloat16);
    Silu_bfloat16(node);
    BENCH_END(Silu_bfloat16);
    ...
    BENCH_START(Silu_bfloat16_rvv);
    Silu_bfloat16_rvv(node);
    BENCH_END(Silu_bfloat16_rvv);
