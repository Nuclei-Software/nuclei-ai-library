...
int test_elu_f32(void)
{
    ...
    BENCH_START(Elu_float32);
    Elu_float32(node);
    BENCH_END(Elu_float32);
    ...
    BENCH_START(Elu_float32_rvv);
    Elu_float32_rvv(node);
    BENCH_END(Elu_float32_rvv);
...
int test_elu_f16(void)
{
    ...
    BENCH_START(Elu_float16);
    Elu_float16(node);
    BENCH_END(Elu_float16);
    ...
    BENCH_START(Elu_float16_rvv);
    Elu_float16_rvv(node);
    BENCH_END(Elu_float16_rvv);
