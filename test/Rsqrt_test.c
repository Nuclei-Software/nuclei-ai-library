...
int test_rsqrt_bf16(void)
{
    ...
    BENCH_START(Rsqrt_bfloat16);
    Rsqrt_bfloat16(node);
    BENCH_END(Rsqrt_bfloat16);
    ...
    BENCH_START(Rsqrt_bfloat16_rvv);
    Rsqrt_bfloat16_rvv(node);
    BENCH_END(Rsqrt_bfloat16_rvv);
