...
int test_pow_f32(void)
{
    ...
    node->ninput = 1;
    float32_t exponent = rand() % 5;
    node->priv = GeneratePowParam((OnnxScalar)exponent);
    ...
    BENCH_START(Pow_float32);
    Pow_float32(node);
    BENCH_END(Pow_float32);
    ...
    BENCH_START(Pow_float32_rvv);
    Pow_float32_rvv(node);
    BENCH_END(Pow_float32_rvv);
...
int test_pow_f16(void)
{
    ...
    BENCH_START(Pow_float16);
    Pow_float16(node);
    BENCH_END(Pow_float16);
    ...
    BENCH_START(Pow_float16_rvv);
    Pow_float16_rvv(node);
    BENCH_END(Pow_float16_rvv);
...
int test_pow_bf16(void)
{
    ...
    BENCH_START(Pow_bfloat16);
    Pow_bfloat16(node);
    BENCH_END(Pow_bfloat16);
    ...
    BENCH_START(Pow_bfloat16_rvv);
    Pow_bfloat16_rvv(node);
    BENCH_END(Pow_bfloat16_rvv);
