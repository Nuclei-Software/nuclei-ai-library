...
int test_sub_int8(void)
{
    ...
    BENCH_START(Sub_int8_rvv);
    Sub_int8_rvv(node);
    BENCH_END(Sub_int8_rvv);
...
int test_sub_f16(void)
{
    ...
    BENCH_START(Sub_float16);
    Sub_float16(node);
    BENCH_END(Sub_float16);
    ...
    BENCH_START(Sub_float16_rvv);
    Sub_float16_rvv(node);
    BENCH_END(Sub_float16_rvv);
...
int test_sub_bf16(void)
{
    ...
    BENCH_START(Sub_bfloat16);
    Sub_bfloat16(node);
    BENCH_END(Sub_bfloat16);
    ...
    BENCH_START(Sub_bfloat16_rvv);
    Sub_bfloat16_rvv(node);
    BENCH_END(Sub_bfloat16_rvv);
...
int test_sub_f32(void)
{
    ...
    BENCH_START(Sub_float32);
    Sub_float32(node);
    BENCH_END(Sub_float32);
    ...
    BENCH_START(Sub_float32_rvv);
    Sub_float32_rvv(node);
    BENCH_END(Sub_float32_rvv);
