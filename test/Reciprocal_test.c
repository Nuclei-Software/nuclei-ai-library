...
int test_reciprocal_f32(void)
{
    ...
    BENCH_START(Reciprocal_float32);
    Reciprocal_float32(node);
    BENCH_END(Reciprocal_float32);
    ...
    BENCH_START(Reciprocal_float32_rvv);
    Reciprocal_float32_rvv(node);
    BENCH_END(Reciprocal_float32_rvv);
...
int test_reciprocal_f16(void)
{
    ...
    BENCH_START(Reciprocal_float16);
    Reciprocal_float16(node);
    BENCH_END(Reciprocal_float16);
    ...
    BENCH_START(Reciprocal_float16_rvv);
    Reciprocal_float16_rvv(node);
    BENCH_END(Reciprocal_float16_rvv);
...
int test_reciprocal_bf16(void)
{
    ...
    BENCH_START(Reciprocal_bfloat16);
    Reciprocal_bfloat16(node);
    BENCH_END(Reciprocal_bfloat16);
    ...
    BENCH_START(Reciprocal_bfloat16_rvv);
    Reciprocal_bfloat16_rvv(node);
    BENCH_END(Reciprocal_bfloat16_rvv);
...
int test_reciprocal(void)
{
    int ret = 0;
    ret |= test_reciprocal_f32();
#if defined(RISCV_FLOAT16_RVV_SUPPORTED)
    ret |= test_reciprocal_f16();
#endif /* #if defined(RISCV_FLOAT16_RVV_SUPPORTED) */
#if defined(RISCV_BFLOAT16_RVV_SUPPORTED)
    ret |= test_reciprocal_bf16();
#endif /* #if defined(RISCV_BFLOAT16_RVV_SUPPORTED) */
    return ret;
}