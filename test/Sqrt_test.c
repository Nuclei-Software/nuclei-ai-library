...
int test_sqrt_f32(void)
{
    ...
    BENCH_START(Sqrt_float32);
    Sqrt_float32(node);
    BENCH_END(Sqrt_float32);
    ...
    BENCH_START(Sqrt_float32_rvv);
    Sqrt_float32_rvv(node);
    BENCH_END(Sqrt_float32_rvv);
...
int test_sqrt_f16(void)
{
    ...
    BENCH_START(Sqrt_float16);
    Sqrt_float16(node);
    BENCH_END(Sqrt_float16);
    ...
    BENCH_START(Sqrt_float16_rvv);
    Sqrt_float16_rvv(node);
    BENCH_END(Sqrt_float16_rvv);
...
int test_sqrt_bf16(void)
{
    ...
    BENCH_START(Sqrt_bfloat16);
    Sqrt_bfloat16(node);
    BENCH_END(Sqrt_bfloat16);
    ...
    BENCH_START(Sqrt_bfloat16_rvv);
    Sqrt_bfloat16_rvv(node);
    BENCH_END(Sqrt_bfloat16_rvv);
