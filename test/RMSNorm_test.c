...
BENCH_DECLARE_VAR()
int test_rmsnormalization_f32(void)
{
    ...
    node->priv = GenerateRMSNormParam(1e-05f, 0.9f);
    ...
    BENCH_START(RMSNormalization_float32);
    RMSNormalization_float32(node);
    BENCH_END(RMSNormalization_float32);
    ...
    BENCH_START(RMSNormalization_float32_rvv);
    RMSNormalization_float32_rvv(node);
    BENCH_END(RMSNormalization_float32_rvv);
...
int test_rmsnormalization_f16(void)
{
    struct onnx_node_t *node;
    ...
    BENCH_START(RMSNormalization_float16);
    RMSNormalization_float16(node);
    BENCH_END(RMSNormalization_float16);
    ...
    BENCH_START(RMSNormalization_float16_rvv);
    RMSNormalization_float16_rvv(node);
    BENCH_END(RMSNormalization_float16_rvv);
...
int test_rmsnormalization_bf16(void)
{
    struct onnx_node_t *node;
    ...
    BENCH_START(RMSNormalization_bfloat16);
    RMSNormalization_bfloat16(node);
    BENCH_END(RMSNormalization_bfloat16);
    ...
    BENCH_START(RMSNormalization_bfloat16_rvv);
    RMSNormalization_bfloat16_rvv(node);
    BENCH_END(RMSNormalization_bfloat16_rvv);
...
int test_rmsnormalization(void)
{
    int ret = 0;
#if defined(RISCV_FLOAT16_RVV_SUPPORTED)
    ret |= test_rmsnormalization_f16();
#endif /* #if defined(RISCV_FLOAT16_RVV_SUPPORTED) */
#if defined(RISCV_BFLOAT16_RVV_SUPPORTED)
    ret |= test_rmsnormalization_bf16();
#endif /* #if defined(RISCV_BFLOAT16_RVV_SUPPORTED) */
    ret |= test_rmsnormalization_f32();
    return ret;
}