...
int test_negate_bf16(void)
{
    ...
    BENCH_START(Negate_bfloat16);
    Negate_bfloat16(node);
    BENCH_END(Negate_bfloat16);
    ...
    BENCH_START(Negate_bfloat16_rvv);
    Negate_bfloat16_rvv(node);
    BENCH_END(Negate_bfloat16_rvv);
