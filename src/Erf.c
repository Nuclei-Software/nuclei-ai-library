...
void Erf_float16_rvv(struct onnx_node_t *n)
{
    ...
    for (; (l = __riscv_vsetvl_e16m8(blkCnt)) > 0; blkCnt -= l) {
        ...
        _x = __riscv_vfmul_vf_f16m8_tumu(_mask, _x, _x, -1.0f, l);
        ...
        _y = __riscv_vfmul_vf_f16m8_tumu(_mask, _y, _y, -1.0f, l);
...
void Erf_float32_rvv(struct onnx_node_t *n)
{
    ...
    for (; (l = __riscv_vsetvl_e32m8(blkCnt)) > 0; blkCnt -= l) {
        ...
        _x = __riscv_vfmul_vf_f32m8_tumu(_mask, _x, _x, -1.0f, l);
        ...
        _y = __riscv_vfmul_vf_f32m8_tumu(_mask, _y, _y, -1.0f, l);
